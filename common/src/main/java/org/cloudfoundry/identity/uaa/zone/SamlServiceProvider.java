...
@JsonSerialize(using = SamlServiceProvider.IdentityProviderSerializer.class)
@JsonDeserialize(using = SamlServiceProvider.IdentityProviderDeserializer.class)
public class SamlServiceProvider<T extends AbstractIdentityProviderDefinition> {
    ...
    public SamlServiceProvider setConfig(T config) {
    ...
    public SamlServiceProvider setOriginKey(String originKey) {
    ...
    public SamlServiceProvider setType(String type) {
        this.type = type;
        return this;
    }
...
//        sb.append(", identityZoneId='").append(identityZoneId).append('\'');
    ...
    public static class IdentityProviderSerializer extends JsonSerializer<SamlServiceProvider> {
        @Override
    ...
    public static class IdentityProviderDeserializer extends JsonDeserializer<SamlServiceProvider> {
        @Override
